...
module "policy" {
  ...
  PROFILE_BUCKET_ARN                         = module.s3_profile.PROFILE_BUCKET_ARN 
...
module "lambda" {
  ...
  CONVERSATION_TABLE_NAME = module.conversation_table_dynamodb.table_name
  JOURNALS_TABLE_NAME     = module.journals_table_dynamodb.table_name
  MESSAGES_TABLE_NAME     = module.messages_table_dynamodb.table_name
  CONNECTION_TABLE_NAME   = module.connection_table_dynamodb.table_name 
  PROFILE_BUCKET_NAME     = module.s3_profile.PROFILE_BUCKET_NAME
  ...
  PROFILE_SETTINGS_FUNCTION_ROLE_ARN        = module.role.PROFILE_SETTINGS_FUNCTION_ROLE_ARN
...
module "messages_table_dynamodb" {
  source           = "./module/dynamodb/messages_table"
  ENV              = var.ENV
  AWS_REGION       = var.region
  RESOURCES_PREFIX = local.RESOURCES_PREFIX
